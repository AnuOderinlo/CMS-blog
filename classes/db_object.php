...
class Db_object{
	...
	//This method is used in extracting the object specific properties(The database fields that are needed)  and it is an associative array
	...
	public function set_file($file){
		...
		if (empty($file) || !$file || !is_array($file)) {
			...
			return $this->image = basename($file['name']);
		}
